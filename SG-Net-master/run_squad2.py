...
class SimpleNlp(object):
    def __init__(self):
        print("---------------Inside SimpleNLP class init func()")
    ...
    for entry in tqdm(input_data,ncols=50,desc="reading examples:"):
        for paragraph in entry["paragraphs"]:
            ...
            for sen_ix, sent in enumerate(sen_texts.sents):
                sent_tokens = []
                print("@@@@@@@@@@@@@@     -------xxxx-------", type(sent), sent)
                prev_is_whitespace = True
                for c in str(sent):     #changet sent.string to str(sent)
                    if is_whitespace(c):
                        prev_is_whitespace = True
                    else:
...
def main():
    ...
    if args.do_train:
        ...
        logger.info("  Num of training examples = %d", len(train_examples))
        ...
        for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration", ncols=50)):
                ...
                #print("Printing the model.....................................----------xxxxxxxxxxxxxx-----------.............................", model)
                ...
                #freeing cuda cache
                torch.cuda.empty_cache()
                #print("cuda max memory cached....", torch.cuda.max_memory_reserved())
    ...
    if args.do_predict and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            output_model_file = os.path.join(args.output_dir, "epoch_" + str(epoch) + "_pytorch_model.bin")
            print("Output model file name... ", output_model_file)
            torch.cuda.empty_cache()
