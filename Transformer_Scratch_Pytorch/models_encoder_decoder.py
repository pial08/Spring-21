...
from utils import translate_sentence, bleu, save_checkpoint, load_checkpoint, print_debug, count_parameters
...
class TransformerModel(nn.Module):
    ...
    def __init__(self, 
        ...
        self.pos_encoder = nn.Embedding(max_len, emsize)
        ...
        """
        self.encoder_norm = nn.LayerNorm(emsize)
        self.decoder_norm = nn.LayerNorm(emsize)
        ...
        self.transformer_encoder = nn.TransformerEncoder(self.encoder_layers, nlayers, self.encoder_norm)
        self.transformer_decoder = nn.TransformerDecoder(self.decoder_layers, nlayers, self.decoder_norm)
